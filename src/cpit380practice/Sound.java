...
/**
 * Class that represents a sound.  This class is used by the 
 * students to extend the capabilities of SimpleSound. 
 * 
...
public class Sound extends SimpleSound
{
  ...
  /**
   * Method to pick a sound file, create the sound object, play the 
   * sound object, and return the sound object
  ...
  /**
   * Method to play a specific sound.  The sound to play is 
   * specified in the method.  To change the sound that this
   * method plays change the file name in the method and recompile
   * @return the created sound object 
   */
  ...
  /**
   * Method to create a sound object from the given file name and
   * play the sound.  It also returns the created sound object
   * @return the created sound object
   */
  ...
  /**
   * Method that just shows how to get each sample value and
   * set it again
   */
  public void doNothing()
  {
   ...
   /**
   * Method to go through each sound sample and set the sample
   * value to the original value.
   * This is simply a template for processing sounds using an
...
//  }
  ...
  /**
   * Method to double the volume (amplitude) 
   * of the sound, using a for each loop
   */
  ...
  /**
   * Method to halve the volumne for positive
   * and double the volume for negative sound
   * values
   */
   ...
   * in a sound and print it, it will
   * also return it
   */
  ...
  /**
   * Method to change 200 values in the middle 
   * of a sound to the passed amount
  ...
  /**
   * Method to double the volume (amplitude) of 
   * the sound using a while loop
   */
  ...
  /**
   * Method to increase the volume (double it)
   * using a for loop
   */
  ...
  /**
   * Method to modify the volume by the passed 
   * factor in the passed range
   ...
   * by multiplying the current values in the sound by
   * the passed factor.
   ...
   * @param start the index of the starting value
   * (inclusive)
   * @param end the index of the ending value 
   * (not inclusive)
   */
...
//        }
  ...
  /**
   * Method to normalize the first second of the sound
   * and then decrease the volume by 1/5 for 
  ...
  /**
   * Method to have a linear increase in volume
   * to halfway and then a linear decrease in 
   * volume
   * @param maxChange the change at halfway will
   * be maxChange 
   */
  ...
  /**
   * Method to modify a sound to start at lower vol and increase
   * the volume linearly in num steps to the volume at the passed index
  ...
  public void decreaseVolBeforeIndex(int index, int numSteps)
  {
   ...
   /**
   * Method to modify a sound to end at lower vol and increase
   * the volume linearly in num steps back to the volume at the
   * passed index
   * @param index the index to stop the change at
   * @param numSteps the number of steps to increase
   */
  ...
  /**
   * Method to set all the sample values to the maximum positive 
   * value if they were positive (including 0) and the minimum 
  ...
  /**
   * Method to increase the first half of the sound (double it) 
   * and then decrease the second half (half it).
   */
  ...
  /**
   * Method to splice "We the " then "United" then
   * "people of the United States" into the current
   * sound
   */
  ...
  /**
   * Method to splice "We the " then "United" 
   * normalized (as loud as possible) then
   * "people of the United States" into the current
   * sound
   */
  ...
  /**
   * Method to splice "United" into "We the people of the United 
   * States" by adding it after the "the"
  ...
  /**
   * Method to splice the preamble into the current sound so that
   * it says We the United people of the United States
   */
  ...
  /**
   * Method to reverse the last half of the 
   * current sound.  
   */
  ...
  /**
   * Method to create a sound from this is a test
   * and erase the 2nd second of it, play it,
   * and then return the resulting sound
   */
  ...
  /**
   * Method to overlap or blend two sounds.  Start
   * by copying the first 20,000 samples from sound1 into
   * the target sound then copy the sum of half of sound1
   * and half of sound2 for the next 20,000 samples and
   * end with the next 20,000 samples from sound2.
   */
   ...
   * Method to overlap or blend two sounds.  Start
   * by copying the first 20,000 samples from sound1 into
   * the current sound then copy the sum of half of sound1
   * and half of sound2 for the next 20,000 samples and
   * end with the next 20,000 samples from sound2.
   */
  ...
  /**
   * Method to overlap or blend 3 sounds.  Start
   * by copying the first 20,000 samples from sound1 into
   * the end sound then copy the sum of half 
   * of the sound1 value and half of the sound2 value for
   * 20,000 samples.  Then copy the sum of half of 
   * the sound2 value and half of the sound3 value 
   * for the next 20,000 samples end with the 
   * next 20,000 samples from sound3.
   */
  ...
  /**
   * Method to overlap or blend two sounds at the halfway
   * point in sound1.  Start
   * by copying the first half of the samples from 
   * sound1 into the current sound then copy the 
   * sum of half of sound1 and sound2 for the rest 
   ...
   * @param delay the number of samples before 
   * the echo starts
   */
   ...
   * every second sample.  The result will be a higher 
   * sound.
   */
  ...
  /**
   * Try to make this sound like a hip-jop dj
   * playing a sound forward and backwards quickly
   */
  ...
  /**
   * Method to triple the frequency of a sound by taking
   * every third sample.  The result will be a higher 
   * sound.
   */
  ...
  /**
   * Method to halve the frequency of a sound by taking
   * each sample twice.  The result will be a lower
   * sound. 
   */
  ...
  /**
   * Method to change the frequency of a sound by the 
   * passed factor
   * @param factor the amount to increment the source 
   ...
   * frequency and make the sound lower.
   */
  ...
  /**
   * Method to change the frequency of a sound 
   * by the passed factor and return the resulting sound
   * @param factor the amount to increment the source 
   * index by.  A number greater than 1 will increase the 
   * frequency and make the sound higher
   * while a number less than one will decrease the frequency 
   ...
   * while a number less than one will decrease the frequency 
   * and make the sound lower.
   * @param numSamples the length of the new sound as a number
   * of samples (should be <= length * (1/factor))
   * @return the resulting sound
   */
...
//  }
  ...
  /**
   * Method to play a sound 5 times and each time increase the 
   * frequency.  It doesn't change the original sound.
   */
  ...
  /**
   * Method to play a sound 10 times and each time 
   * increase the frequency.  It doesn't change 
   * the original sound.
   */
  ...
  /**
   * Method to create a one second sine wave sound with the 
   * given frequency and maximum amplitude
   * @param freq the desired frequency
  ...
  /**
   * Method to copy a sine wave with the given
   * frequency and maximum amplitude to the current sound
   * @param freq the desired frequency
   * @param maxAmplitude the maximum amplitude
   */
  ...
  /**
   * Method to generate a 1 second sound with square waves
   * with the passed frequency and maximum amplitude.
   * @param freq the desired frequency
   * @param maxAmplitude the maximum amplitude
  ...
  /**
   * Method to create a one second triangle wave sound 
   * with the given frequency and maximum amplitude
   * @param freq the desired frequency
   * @param maxAmplitude the maximum amplitude
   * @return the new sound
   */
  ...
  /**
   * Method to create a one second pyramid 
   * (cut off triangle) wave sound 
   * with the given frequency and maximum amplitude
   * @param freq the desired frequency
   * @param maxAmplitude the maximum amplitude
   * @return the new sound
  ...
  /**
   * Method to write out the values in the sound to a file
   * as text
